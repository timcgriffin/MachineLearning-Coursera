...
% Expands y output values into a matrix of single values.
y_matrix = eye(num_labels)(y,:);

% Implement forward propation.
a1 = [ones(m, 1) X];
z2 = a1 * Theta1';
a2 = sigmoid(z2);
...
% Note: taking the sum twice is effectively doing the same work as nested for loops
